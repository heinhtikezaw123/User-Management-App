                            ...
                            <form method="post" action="{{ route('admin#uploadFile') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3 mt-4">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" name="storage" id="storage_local" value="local" class="form-check-input" checked>
                                        <label for="storage_local" class="form-check-label">Local Storage</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="storage" id="storage_do" value="do" class="form-check-input">
